...
var FUEL = {
	...
	Switch: {
		...
		pump1Aft: props.globals.getNode("/controls/fuel/switches/pump-1-aft"),
		pump1Fwd: props.globals.getNode("/controls/fuel/switches/pump-1-fwd"),
		pump2LAft: props.globals.getNode("/controls/fuel/switches/pump-2l-aft"),
		pump2RAft: props.globals.getNode("/controls/fuel/switches/pump-2r-aft"),
		pump2Fwd: props.globals.getNode("/controls/fuel/switches/pump-2-fwd"),
		pump3Aft: props.globals.getNode("/controls/fuel/switches/pump-3-aft"),
		pump3Fwd: props.globals.getNode("/controls/fuel/switches/pump-3-fwd"),
