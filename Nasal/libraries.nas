...
setlistener("/systems/fcs/spoilers/lever-input", func() {
	if (pts.Sim.Sound.speedbrakeClick.getBoolValue()) {
		return;
	}
	pts.Sim.Sound.speedbrakeClick.setBoolValue(1);
	settimer(func() {
		pts.Sim.Sound.speedbrakeClick.setBoolValue(0);
	}, 0.4);
}, 0, 0);
