...
var Payload = {
	...
	Weight: {
		maxLb: [props.globals.getNode("/payload/weight[0]/max-lb"), props.globals.getNode("/payload/weight[1]/max-lb"), props.globals.getNode("/payload/weight[2]/max-lb"), props.globals.getNode("/payload/weight[3]/max-lb"), props.globals.getNode("/payload/weight[4]/max-lb"), props.globals.getNode("/payload/weight[5]/max-lb")],
...
var Sim = {
	...
	Sound: {
		...
		speedbrakeClick: props.globals.initNode("/sim/sound/speedbrake-click", 0, "BOOL"),
